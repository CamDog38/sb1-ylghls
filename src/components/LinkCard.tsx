...
export const LinkCard: React.FC<Props> = ({ item }) => {
  ...
  return (
    <div
      ref={setNodeRef}
      style={style}
      className="bg-white rounded-lg shadow hover:shadow-md transition-all duration-200 relative group"
    >
      <div className="flex items-center">
        <div {...attributes} {...listeners} className="p-4 cursor-grab touch-none">
